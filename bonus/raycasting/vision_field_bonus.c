...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   vision_field_bonus.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hselbi <hselbi@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/07 01:15:59 by hselbi            #+#    #+#             */
/*   Updated: 2022/12/09 20:31:38 by hselbi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	hor_vfield(t_cub *cub, t_field *v_field, float ra)
{
	v_field->h = 1;
	if (ra > PI && ra < 2 * PI)
	{
...
void	ver_vfield(t_cub *cub, t_field *v_field, float ra)
{
...
void	v_field(t_cub *cub, int x, float ra)
{
	...
	if ((cub->p.f_hor == 1 && cub->p.hx == cub->p.rx))
		hor_vfield(cub, &v_field, ra);
	else if ((cub->p.f_ver == 1 && cub->p.vy == cub->p.ry))
		ver_vfield(cub, &v_field, ra);
